...
<section id="content">
	<div id="main-content">
		...
		<article>
			<div class="heading">
				<h2><a href="perfil.php">Grupo Matematica</a></h2>
			</div>
			<div class="content">
		...
		<article>
			<div class="heading">
				<h2><a href="perfil.php">Estefano Garcia</a></h2>
			</div>
			<div class="content">
		...
		<article>
			<div class="heading">
				<h2><a href="perfil.php">Mateo Mejia</a></h2>
			</div>
			<div class="content">
	...
	<div id="sidebar">
		<section>
			<div class="heading"><h2><a href="perfil.php">Stefy Coello</a></h2></div>
			<img src="images/perfil.jpg">
		</section>
		<section>
			<div class="heading"><h2>Mas Utilizados</h2></div>
			<div class="content">
				<div class="post">
